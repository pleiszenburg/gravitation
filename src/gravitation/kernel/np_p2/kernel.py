...
https://github.com/pleiszenburg/gravitation
    ...
    src/gravitation/kernel/np_p2/kernel.py: Kernel
...
__longname__ = "numpy-backend (parallel 2)"
__version__ = "0.0.2"
__description__ = "numpy backend, no memory allocations, optimal memory layout, concurrent futures threads"
    ...
    def step_stage1(self):
        ...
        for idx, segment in enumerate(self._segments):
            futures.append(self._pool.submit(
                self._step_stage1_thread,
                segment.start, segment.stop, idx,
            ))
