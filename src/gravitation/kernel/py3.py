...
class Universe(UniverseBase):
    ...
    def _update_pair(self, i: int):
        ...
        relative_r = [
            [
                ri - rn
                for rn in islice(rd, i + 1, None)
            ]
            for rd, ri in zip(self._r, ri)
        ]
        ...
        a = [
            sum(ri * ad for ri in rs)
            for rs, ad in zip(zip(*relative_r), a1)
        ]
    ...
    def push_stage1(self):
        ...
        self._r = [
            [
                pm.r[dim] for pm in self._masses
            ]
